...
public enum TavernBrawlPhase { Idle, Registration, Rolling, PendingChoice, Done }
...
public sealed class TavernBrawlState : IGameState {
    ...
    public bool IsActive => Phase is TavernBrawlPhase.Registration or TavernBrawlPhase.Rolling or TavernBrawlPhase.PendingChoice;
